...
SELECT cus.firstname + ' ' + cus.lastname as 'Full Name', inv.CustomerID, inv.InvoiceId, cus.Address, cus.Country
From invoice as inv 
    inner join customer as cus on inv.customerid = cus.customerid
